        <div class="event-summary">
         ...
         <div class="event-summary__content">
          ...
          <p><?php if (has_excerpt()) { // has_excerpt(): Condición que devuelve true si el post actual tiene un extracto definido manualmente.
              echo get_the_excerpt(); // get_the_excerpt(): Devuelve el extracto del post actual.
             } else echo wp_trim_words(get_the_content(), 18); // wp_trim_words(): Recorta una cadena a un número específico de palabras. get_the_content(): Devuelve el contenido completo del post actual.
